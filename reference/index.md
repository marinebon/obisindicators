...
Connect to, summarize, query and benchmark an obis_h3 DuckDB store from
R.
...
Calculate indicators, and the paper’s analyses: scale curves,
rank-column vs subtree, EOV totals, SPUE vs SDM, periods, and place
roll-ups.
