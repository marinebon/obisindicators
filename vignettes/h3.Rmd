---
title: "H3 grids and deckgl"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{H3 grids and deckgl}
...
```{r, include = FALSE}
# the h3-grid → indicator → map pipeline runs on shipped occ_1M (same as
# vignette("obisindicators")); only the deckgl demo below stays code-only, since
# it installs from GitHub and needs a browser to render.
