...
by `SDM_TIF` (here the AquaMaps environmental-envelope probability surface for
the species, 0–100, from the MarineSensitivity marine atlas — a *graded* surface;
a range mask is constant inside the range and gives no correlation).
