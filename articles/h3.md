...
![](h3_files/figure-html/map_gcs-1.png)

### References

- [crazycapivara/h3-r: R bindings for H3, a hierarchical hexagonal
  geospatial indexing system](https://github.com/crazycapivara/h3-r)
- [Introduction to H3 for R • H3 for
  R](https://crazycapivara.github.io/h3-r/articles/h3.html)
...
- [Introduction to r-deckgl • deckgl for
  R](https://crazycapivara.github.io/deckgl/articles/deckgl.html)
- [Add a h3 cluster layer to the deckgl widget — add_h3_cluster_layer •
  deckgl for
  R](https://crazycapivara.github.io/deckgl/reference/add_h3_cluster_layer.html)
- [H3: Area Variation / Nick Rabinowitz /
  Observable](https://observablehq.com/@nrabinowitz/h3-area-variation)
- [Mapbox Utils / Nick Rabinowitz /
  Observable](https://observablehq.com/@nrabinowitz/mapbox-utils#fixTransmeridian)
